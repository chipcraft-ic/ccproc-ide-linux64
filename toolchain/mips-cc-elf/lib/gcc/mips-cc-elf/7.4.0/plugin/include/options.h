...
#define MASK_PATFREE (1U << 22)
#define MASK_RELAX_PIC_CALLS (1U << 23)
#define MASK_SMARTMIPS (1U << 24)
#define MASK_SPLIT_ADDRESSES (1U << 25)
#define MASK_SYNCI (1U << 26)
#define MASK_VR4130_ALIGN (1U << 27)
...
#define TARGET_PATFREE_P(target_flags) (((target_flags) & MASK_PATFREE) != 0)
...
enum opt_code
{
  ...
  OPT_mabs_ = 1155,                          /* -mabs= */
  OPT_march_ = 1156,                         /* -march= */
  OPT_mbranch_cost_ = 1157,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1158,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1159,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1160,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1161,             /* -mcompact-branches= */
  OPT_mdebug = 1162,                         /* -mdebug */
  OPT_mdebugd = 1163,                        /* -mdebugd */
  OPT_mdivide_breaks = 1164,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1165,                  /* -mdivide-traps */
  OPT_mdmx = 1166,                           /* -mdmx */
  OPT_mdouble_float = 1167,                  /* -mdouble-float */
  OPT_mdsp = 1168,                           /* -mdsp */
  OPT_mdspr2 = 1169,                         /* -mdspr2 */
  OPT_meb = 1170,                            /* -meb */
  OPT_mel = 1171,                            /* -mel */
  OPT_membedded_data = 1172,                 /* -membedded-data */
  OPT_meva = 1173,                           /* -meva */
  OPT_mexplicit_relocs = 1174,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1175,                  /* -mextern-sdata */
  OPT_mfix_24k = 1176,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1177,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1178,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1179,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1180,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1181,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1182,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1183,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1184,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1185,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1186,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1187,                 /* -mfp-exceptions */
  OPT_mfp32 = 1188,                          /* -mfp32 */
  OPT_mfp64 = 1189,                          /* -mfp64 */
  OPT_mfpxx = 1190,                          /* -mfpxx */
  OPT_mframe_header_opt = 1191,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1192, */              /* -mfused-madd */
  OPT_mgp32 = 1193,                          /* -mgp32 */
  OPT_mgp64 = 1194,                          /* -mgp64 */
  OPT_mgpopt = 1195,                         /* -mgpopt */
  OPT_mhard_float = 1196,                    /* -mhard-float */
  OPT_mimadd = 1197,                         /* -mimadd */
  OPT_minterlink_compressed = 1198,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1199,              /* -minterlink-mips16 */
  OPT_mips = 1200,                           /* -mips */
  OPT_mips16 = 1201,                         /* -mips16 */
  OPT_mips3d = 1202,                         /* -mips3d */
  OPT_mllsc = 1203,                          /* -mllsc */
  OPT_mload_store_pairs = 1204,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1205,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1206,                    /* -mlong-calls */
  OPT_mlong32 = 1207,                        /* -mlong32 */
  OPT_mlong64 = 1208,                        /* -mlong64 */
  OPT_mlra = 1209,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1210,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1211,                           /* -mmad */
  OPT_mmadd4 = 1212,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1213,             /* -mmcount-ra-address */
  OPT_mmcu = 1214,                           /* -mmcu */
  OPT_mmemcpy = 1215,                        /* -mmemcpy */
  OPT_mmicromips = 1216,                     /* -mmicromips */
  OPT_mmsa = 1217,                           /* -mmsa */
  OPT_mmt = 1218,                            /* -mmt */
  OPT_mnan_ = 1219,                          /* -mnan= */
  OPT_mno_float = 1220,                      /* -mno-float */
  OPT_mno_flush_func = 1221,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1222,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1223,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1224,                     /* -mno-mips3d */
  OPT_modd_spreg = 1225,                     /* -modd-spreg */
  OPT_mpaired_single = 1226,                 /* -mpaired-single */
  OPT_mpatfree = 1227,                       /* -mpatfree */
  OPT_mplt = 1228,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1229,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1230,               /* -mrelax-pic-calls */
  OPT_mshared = 1231,                        /* -mshared */
  OPT_msingle_float = 1232,                  /* -msingle-float */
  OPT_msmartmips = 1233,                     /* -msmartmips */
  OPT_msoft_float = 1234,                    /* -msoft-float */
  OPT_msplit_addresses = 1235,               /* -msplit-addresses */
  OPT_msym32 = 1236,                         /* -msym32 */
  OPT_msynci = 1237,                         /* -msynci */
  OPT_mtune_ = 1238,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1239,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1240,                          /* -mvirt */
  OPT_mvr4130_align = 1241,                  /* -mvr4130-align */
  OPT_mxgot = 1242,                          /* -mxgot */
  OPT_mxpa = 1243,                           /* -mxpa */
  OPT_n = 1244,                              /* -n */
  OPT_no_canonical_prefixes = 1245,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1246,              /* -no-integrated-cpp */
  OPT_no_pie = 1247,                         /* -no-pie */
  OPT_noasmopt = 1248,                       /* -noasmopt */
  ...
  OPT_quiet = 1274,                          /* -quiet */
  OPT_r = 1275,                              /* -r */
  OPT_remap = 1276,                          /* -remap */
  OPT_s = 1277,                              /* -s */
